...
import { findRange } from '../../infrastructure/persistence/repositories/candles.repository';
import { getOrCreateSymbol } from '../../infrastructure/persistence/repositories/symbols.repository';
import { getOrCreateTimeframe } from 'src/data-center/infrastructure/persistence/repositories/timeframes.repository';
